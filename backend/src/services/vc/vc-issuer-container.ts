import type { IVCCredentialIssuer, IOAuthCallback } from "./vc-issuer.js";
import type { ILogger } from "../../backbone/logger.js";
import type { OAuthState } from "../../types/codec/oauth.js";
...
type UnknownCredentialIssuer = IVCCredentialIssuer<
  IssueReq,
  Credential,
  ChallengeReq,
  Challenge,
 ...
 * Issued VC
 */
export class VCIssuerContainer implements Disposable {
